...
internal class YouTubeRepositoryImpl @Inject constructor(
    ...
    override suspend fun searchYouTubeByKeyword(keyword: String, nextPageToken: String?): Result<YouTubeSearchResult> {
        return remote.fetchSearchResult(keyword, nextPageToken).map { searchResultData ->
